...
if(H){if(J.attribValue&&J.attribValue.length){
	...
	if(H.value == _pre_stripped[i]){//alert("iRoot=" + H.value + "; SRpreReq Value=" + _pre_stripped[i]);
		K=true;
		}
...
delete B.OnReady.timer;B.OnReady.onload();}},10);}else{if(document.addEventListener){B.OnReady.onload();
