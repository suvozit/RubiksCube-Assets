...
var _om_tn_centers = {
    bi: "msstotnctbi", biztalk: "msstotnctbiztalk", dpm: "msstotnctdpm", desktopdeployment: "msstotnctdeskdep", edge: "msstotnctedge", exchange: "msstotnctexch",
    forefront: "msstotnctforefrnt", hpc: "msstotncthpc", ie: "msstotnctie", lync: "msstotnctlync", magazine: "msstotnctmag", msonline: "msstotnctmson",
...
// added bi: "msstotnctbi" for 9/29/10
...
var _om_msdn_centers = {
    ...
    directx: "msstoctdx", dynamics: "msstoctdynamics", windowsembedded: "msstoctembed", evalcenter: "msstocteval", exchange: "msstoctexch", fsharp: "msstoctfsharp",
    goglobal: "msstoctgoglob", healthvault: "msstocthealth", ie: "msstoctie", lightswitch: "msstoctlswitch", magazine: "msstoctmag",
    office: "msstoctoffice", openspecifications: "msstoctopen", oslo: "msstoctoslo", practices: "msstoctpandp",
    rampup: "msstoctrampup", robotics: "msstoctrobotics", scriptjunkie: "msstomsdnscjnkie", security: "msstoctsecurity", sharepoint: "msstoctshare",
    ...
    vsx: "msstoctvsx", teamsystem: "msstoctvsts", vsto: "msstoctvsto", windows: "msstoctwin", windowsazure: "msstoctazure",
    windowslive: "msstoctwinlive", windowsmobile: "msstoctwinmob", windowsphone: "msstoctwinphone", windowsserver: "msstoctwinserv", xml: "msstoctxml"
}
// added msdn center scriptjunkie to existing msstomsdnscjnkie (used for gallery) for 8/10 release
// added windowsazure for 8/10 release, center changed from azure to windowsazure
// added windowsphone : "msstoctwinphone" for 8/10 release
// added windowslive : "msstoctwinlive" for 8/10 release
...
var _om_msdn_uber_blogs = {
    ie: "msstouberie", askie: "msstouberie", rds: "msstoubtnwinserv"
}
var _om_msdn_uber_gallery = {}

var _om_msdn_uber_split_params = {
    msdnlib_webdev: "msstouberie",
    _technet_library_sqlserver_: "msstoubtnsql", _technet_library_win7_: "msstoubtnwin",
    scriptcenter_technet: "msstoubtnscript", _technet_library_security_: "msstoubtnsec",
    _technet_sysinternals_: "msstoubtnsysint", _technet_library_desktopdeployment_: "msstoubtndep",
    _technet_virtualization: "msstoubtnvirt"
}

var _om_tn_uber_forum_iroots = {
    windowsserver: "msstoubtnwinserv",
    forefront: "msstoubtnfore", office: "msstoubtnoff", sharepoint: "msstoubtnshare", sqlserver: "msstoubtnsql", systemcenter: "msstotnubersyscent",
    windows: "msstoubtnwin", scriptcenter: "msstoubtnscript", security: "msstoubtnsec", sysinternals: "msstoubtnsysint", deployment: "msstoubtndep", virtualization: "msstoubtnvirt"
}
var _om_tn_uber_centers = {
    windowsserver: "msstoubtnwinserv", forefront: "msstoubtnfore", office: "msstoubtnoff", sharepoint: "msstoubtnshare",
    sqlserver: "msstoubtnsql", systemcenter: "msstotnubersyscent", windows: "msstoubtnwin", scriptcenter: "msstoubtnscript",
    security: "msstoubtnsec", sysinternals: "msstoubtnsysint", deployment: "msstoubtndep", virtualization: "msstoubtnvirt"
}
var _om_tn_uber_blogs = {
}
var _om_tn_uber_gallery = {}
var _om_tn_uber_split_params = {
    _technet_library_windowsserver_: "msstoubtnwinserv"
}


var _om_tn_split_params = {
    _technet_bi_: "msstotnlibbi", _technet_library_ie_: "msstotnlibie", _technet_library_desktopdeployment_: "msstotnlibdeskdep", _technet_library_exchangeserver_: "msstotnlibexch",
    ...
    scriptcenter_technet: "msstotnctscript", _technet_library_security_: "msstotnlibsecurity",
    _technet_solutionaccelerators_: "msstotnctsolacc", _technet_dynamics_ax: "msstotnlibdynax",
    _technet_dpm_: "msstotnlibsyscent", _technet_essentials_: "msstotnlibsyscent", _technet_library_MDM_: "msstotnlibsyscent",
    _technet_library_publisher_: "msstotnlibsyscent", _sto_technet_library_syscentervmm2008_: "msstotnlibsyscent",
    _sto_technet_library_syscentervmm2007_: "msstotnlibsyscent", _technet_library_windowsserver_WinSvr_2008_: "msstotnlibwinsvr08",
    _technet_library_windowsserver_WinSvr_2003_: "msstotnlibwinsvr03"
}
...
// removed standalone lib rs for solacc, and combined it with msstotnctsolacc for 10/10 release
// added _technet_dynamics_ax : "msstotnlibdynax" for 10/10 release

var _om_msdn_split_params = {
    _msdnlib_es_dev_BTS_2009_: "msstolibbts09", _msdnlib_es_dev_BTS_2006R2_: "msstolibbts06r2",
    msdnlib_devtools_lang_w7ph: "msstoctwinphone", msdnlib_mobile: "msstolibmobile",
    msdnlib_office: "msstoliboffice", _sto_msdn_sql_library: "msstolibsql", _msdn_library_sqlserver_: "msstolibsql",
    msdnlib_webdev: "msstolibwebdev", msdnlib_winphone: "msstoctwinphone", msdnlib_w32_com: "msstolibw32com", windowsazure: "msstoctazure",
    msdn_openspec: "msstoctopen", msdnlib_doj: "msstoctopen", msdnlib_sqlazure: "msstolibsqlazure",
    msdnlib_dotnet_appfabric: "msstolibappfab", msdnlib_dotnet_wcf: "msstolibwcf", msdnlib_dotnet_wf: "msstolibwf", msdnlib_pandp: "msstolibpandp"
}
...
// made msdnlib_dotnet : "msstolibdotnet" a wildcard
// made msdnlib_es_dev : "msstolibesdev" a wildcard
// made   msdnlib_devtools_lang : "msstolibdevtools" a wildcard
...
(function() {
    ...
    if (_om_gbls.host.indexOf('social') > -1) {
        ...
        _om_gbls.addrsid('f', 'social.msdn.microsoft.com/forums', 'msstodpecar');
    ...
    if (_om_gbls.path.indexOf('/de-de/') > -1 && _om_gbls.host.indexOf('msdn') > -1) {
        ...
        _om_gbls.addrsid('f', 'social.msdn.microsoft.com/forums/de-de/', 'msstomsdnmktdederoll');
    ...
    if (_om_gbls.path.indexOf('/de-de/') > -1 && _om_gbls.host.indexOf('technet') > -1) {
        ...
        _om_gbls.addrsid('f', 'social.technet.microsoft.com/forums/de-de/', 'msstotnmktdederoll');
        ...
        _om_gbls.addrsid('f', 'gallery.technet.microsoft.com/scriptcenter/de-de/', 'msstotnmktdederoll');
    }
    ...
    if (_om_gbls.s_account.indexOf('forums') > -1) {
        _om_gbls.app = "forums";
        ...
        if (_om_gbls.href.indexOf("social.technet.microsoft.com/forums") > -1) {
            if (_om_tn_uber_forum_iroots[_om_gbls.iroot]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, _om_tn_uber_forum_iroots[_om_gbls.iroot], ",", 2);
        }
        if (_om_gbls.href.indexOf("social.msdn.microsoft.com/forums") > -1) {
            if (_om_msdn_uber_forum_iroots[_om_gbls.iroot]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, _om_msdn_uber_forum_iroots[_om_gbls.iroot], ",", 2);
        }
    }
        ...
        case "msdn.microsoft.com":
            ...
            if (_om_gbls.center) {
                ...
                try {
                    ...
                    if (_om_msdn_uber_centers[_om_gbls.center]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, _om_msdn_uber_centers[_om_gbls.center], ",", 2);
                } catch (err) { }
            }
            ...
            try {
                if (wtsp) {
                    ...
                    if (_om_msdn_uber_split_params[wtsp]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, _om_msdn_uber_split_params[wtsp], ",", 2);
                }
            } catch (err) { }
        ...
        case "technet.microsoft.com":
            ...
            if (_om_gbls.center) {
                ...
                try {
                    ...
                    if (_om_tn_uber_centers[_om_gbls.center]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, _om_tn_uber_centers[_om_gbls.center], ",", 2);
                } catch (err) { }
            }
            // wtsp defined report suites
            try {
                if (wtsp) {
                    ...
                    if (_om_tn_uber_split_params[wtsp]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, _om_tn_uber_split_params[wtsp], ",", 2);
                }
            } catch (err) { }
            // wtsp rollup based report suites
            try {
                if (wtsp.indexOf("_technet_syscenter") > -1 || wtsp.indexOf("_sto_technet_systemcenter_") > -1 || wtsp.indexOf("_technet_library_opsmanager_") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibsyscent", ",", 2);
            } catch (err) { }
            // ad hoc
        ...
        case "blogs.msdn.com":
            try {
                ...
                if (_om_gbls.blogname.indexOf("/b/") == 0) {
                    ...
                    if (_om_msdn_uber_blogs[_om_gbls.blogname]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, _om_msdn_uber_blogs[_om_gbls.blogname], ",", 2);
                }
            } catch (err) { }
            break;
        case "blogs.technet.com":
            try {
                ...
                if (_om_gbls.blogname.indexOf("/b/") == 0) {
                    _om_gbls.blogname = _om_gbls.blogname.replace(/\/b\//, "");
                    _om_gbls.blogname = _om_gbls.blogname.substring(0, _om_gbls.blogname.indexOf("/"));
                    if (_om_tn_uber_blogs[_om_gbls.blogname]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, _om_tn_uber_blogs[_om_gbls.blogname], ",", 2);
                }
            } catch (err) { }
            break;
    }
    ...
    if (_om_gbls.host == "www.microsoft.com") {
        ...
        _om_gbls.addrsid('f', 'www.microsoft.com/resources/technet/locale/office/', 'msstotnwwwoff');
        _om_gbls.addrsid('f', 'www.microsoft.com/resources/msdn/locale/office/', 'msstowwwoff');
    }
    _om_gbls.addrsid('f', 'gallery.technet.microsoft.com/scriptcenter', 'msstotnctscript');
    _om_gbls.addrsid('f', 'gallery.technet.microsoft.com/scriptcenter', 'msstoubtnscript');
    ...
    if (_om_gbls.host == "technet.microsoft.com" && _om_gbls.library == "1") {
        ...
        if (_om_gbls.wtspparam == "_technet_dpm_") _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibdpm", ",", 2);
        if (_om_gbls.wtspparam.indexOf("_lync") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnliblync", ",", 2);
    }
    if (_om_gbls.host == "msdn.microsoft.com" && _om_gbls.library == "1") {
        if (_om_gbls.wtspparam.indexOf("msdnlib_dotnet") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstolibdotnet", ",", 2);
        if (_om_gbls.wtspparam.indexOf("msdn_openspec") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstoctopen", ",", 2);
        if (_om_gbls.wtspparam.indexOf("msdnlib_es_dev") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstolibesdev", ",", 2);
        if (_om_gbls.wtspparam.indexOf("msdnlib_devtools_lang") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstolibdevtools", ",", 2);
    }


    if (_om_gbls.host.indexOf('social') > -1 || _om_gbls.host.indexOf('code.msdn') > -1) {
    ...
    // 7/21/2009
    if (_om_gbls.getOmniMeta("DCSext.WCversion")) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnwcroll", ",", 2);
    if (_om_gbls.getOmniMeta("DCSext.Care").toLowerCase().indexOf("msdn") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstomsdncare", ",", 2);
    if (_om_gbls.getOmniMeta("DCSext.Care").toLowerCase().indexOf("technet") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotncare", ",", 2);

    // 08/2010 release, for future center support
    try {
        _om_gbls.centrsid = _om_gbls.getOmniMeta("t_omni_center").toLowerCase();
        if (_om_gbls.centrsid.indexOf("mssto") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, _om_gbls.centrsid, ",", 2);
    } catch (e) { }

    // 08/2010 release
    omniservrole = _om_gbls.getOmniMeta("DCS.subject_serverRole").toLowerCase();
    if (omniservrole.indexOf("active directory") > -1) {
        if (omniservrole.indexOf("federation") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibadfs", ",", 2);
        if (omniservrole.indexOf("domain") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibadds", ",", 2);
        if (omniservrole.indexOf("lightweight") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibadlds", ",", 2);
        if (omniservrole.indexOf("certificate") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibadadcs", ",", 2);
        if (omniservrole.indexOf("rights") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibadrms", ",", 2);
    }
    ...
    if (_om_gbls.msdnlibrarynode.indexOf("_pandp") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstolibpandp", ",", 2);

    // 2/2011 release
    if (_om_gbls.prodversion) {
        var tvar = _om_gbls.prodversion.toLowerCase();
        if (tvar == "nap/dsap") _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibixdsap", ",", 2);
        if (tvar == "forefront tmg") _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibixtmg", ",", 2);
        if (tvar == "forefront uag") _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibixuag", ",", 2);
    }
    try { tvar = _om_gbls.getOmniMeta("DCS.appliesToTechnologyArea"); if (tvar.toLowerCase() == "forefront identity management") { _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibixfim", ",", 2); } } catch (e) { }
    ...
    // office technet
    if (_om_gbls.subdom == "technet") {
        var tncentlib = "";
        if ((_om_gbls.center == "office" || _om_gbls.center == "exchange" || _om_gbls.center == "enterprisesearch" || _om_gbls.center == "projectserver" || _om_gbls.center == "searchserver" || _om_gbls.center == "sharepoint" || _om_gbls.center == "vsto" || _om_gbls.center == "lync" || _om_gbls.href.indexOf("/windowsserver/sharepoint/") > -1) && _om_gbls.offprodfam == "TECHNET_OFFICE") {
            tncentlib = "ct";
            // msstotnoff
            try { if (_om_office_centmarkets[_om_gbls.market.replace(/\-/, "")]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnoff" + tncentlib + _om_gbls.market.replace(/\-/, ""), ",", 2); } catch (err) { }
            if (_om_gbls.market.indexOf('en\-') > -1 && _om_gbls.market.indexOf('en\-us') == -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnoff" + tncentlib + "enint", ",", 2);
        }
        if (_om_gbls.offprodfam == "TECHNET_OFFICE" && _om_gbls.library == "1") {
            tncentlib = "lib";
            try { if (_om_office_libmarkets[_om_gbls.market.replace(/\-/, "")]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnoff" + tncentlib + _om_gbls.market.replace(/\-/, ""), ",", 2); } catch (err) { }
            if (_om_gbls.market.indexOf('en\-') > -1 && _om_gbls.market.indexOf('en\-us') == -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnoff" + tncentlib + "enint", ",", 2);
            if (_om_gbls.market.indexOf('es\-') > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnoff" + tncentlib + "esall", ",", 2);
            if (_om_gbls.market.indexOf('de\-') > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnoff" + tncentlib + "deall", ",", 2);
            if (_om_gbls.market.indexOf('fr\-') > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnoff" + tncentlib + "frall", ",", 2);
        }
    }
    ...
    if (_om_gbls.subdom == "msdn") {
        var centlib = "";
        if ((_om_gbls.center == "office" || _om_gbls.center == "sharepoint" || _om_gbls.center == "vsto" || _om_gbls.center == "exchange" || _om_gbls.center == "lync" || _om_gbls.center == "openspecifications") && _om_gbls.offprodfam == "MSDN_OFFICE") {
            centlib = "ct";
            try { if (_om_office_centmarkets[_om_gbls.market.replace(/\-/, "")]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstooff" + centlib + _om_gbls.market.replace(/\-/, ""), ",", 2); } catch (err) { }
            if (_om_gbls.market.indexOf('en\-') > -1 && _om_gbls.market.indexOf('en\-us') == -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstooff" + centlib + "enint", ",", 2);
        }
        if (_om_gbls.offprodfam == "MSDN_OFFICE" && _om_gbls.library == "1") {
            centlib = "lib";
            try { if (_om_office_libmarkets[_om_gbls.market.replace(/\-/, "")]) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstooff" + centlib + _om_gbls.market.replace(/\-/, ""), ",", 2); } catch (err) { }
            if (_om_gbls.market.indexOf('en\-') > -1 && _om_gbls.market.indexOf('en\-us') == -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstooff" + centlib + "enint", ",", 2);
            if (_om_gbls.market.indexOf('es\-') > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstooff" + centlib + "esall", ",", 2);
            if (_om_gbls.market.indexOf('de\-') > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstooff" + centlib + "deall", ",", 2);
            if (_om_gbls.market.indexOf('fr\-') > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstooff" + centlib + "frall", ",", 2);
        }
    }

    if (_om_gbls.offprodfam == "LIB_DG" || _om_gbls.offprodfam == "lib_dg") {
        _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstolibdg", ",", 2);
        if (_om_gbls.offprod.indexOf("VS_") == 0) {
            _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstolibdgvs", ",", 2);
        } else if (_om_gbls.offprod.indexOf("NDP_") == 0) {
            _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstolibdgndp", ",", 2);
        } else if (_om_gbls.offprod.indexOf("ALM_") == 0) {
            _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstolibdgalm", ",", 2);
        }
    }

    // uber centers

    // 9/1/10 release, system center uber rsid
    if (_om_gbls.s_account.indexOf("syscent") > -1) _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnubersyscent", ",", 2);

    // iX rollup
    if (omniservrole.indexOf("active directory") > -1 && _om_gbls.s_account.indexOf("msstotnlibad") > -1) {
        _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibadroll", ",", 2);
        _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibixroll", ",", 2);
    }
    if (_om_gbls.s_account.indexOf("msstotnlibix") > -1) {
        _om_gbls.s_account = _om_gbls.apl(_om_gbls.s_account, "msstotnlibixroll", ",", 2);
    }
...
var t_omni_utils = {
    ...
    omniModTracking: function(obj, mod1, mod2, destURL, type, altText, evts) {
        ...
        // update to differentiate type==5 from type==1
        // pagename = oldpage + _ + mod + altText
    ...
    jsonDeserialize: function(str) { try { if (str === "") { str = '""'; } eval("var p=" + str + ";"); return p; } catch (e) { return null; } }
}
...
(function() {
    ...
    if (_om_gbls.prodversion) s.prop23 = _om_gbls.prodversion; // added for 8/2010 release
    ...
    try {
        tvar = t_omni_utils.getOmniMetaTagData("normalizedurl"); if (tvar) {
            s.eVar27 = tvar;
            s.prop27 = "D=v27";
        }
    } catch (e) { }
    ...
    // updated in Oct2010 out of band to use normalizedurl
    if (_om_gbls.s_account.indexOf("msstolibdg") > -1) {
